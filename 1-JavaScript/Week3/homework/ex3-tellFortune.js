...
-----------------------------------------------------------------------------*/
const numKids = [4, 5, 2, 3, 1];

const partnerNames = ['Jack', 'Amelia', 'Jacob', 'Charlotte', 'Lana'];

const locations = ['The Netherlands', 'Syria', 'Mexico', 'Italy', 'Lebanon'];
...
function tellFortune(childrenNum, partnerName, location, job) {
